...
@Component({
  selector: 'app-evoultionmaster',
  templateUrl: './evoultionmaster.component.html',
  styleUrls: ['./evoultionmaster.component.css']
})
export class EvoultionmasterComponent implements OnInit {
  dataClassification
  ...
  ngOnInit(): void {
    this.dashbordservice.post_surfaceclassification(2018).subscribe(data=>{
...
console.log(this.Annee)
  ...
  this.dashbordservice.post_surfaceFamille(this.Annee).subscribe(data=>{
     this.dataset=[]
    let a:Array<any>=Object.values(data)
    let labels:string[]=[]
  ...
  Proccesus(){
    ...
    this.lineChartData=[]
    this.dashbordservice.post_surfaceProccessus(this.Annee).subscribe(data=>{
      console.log(data)
      this.dataset=[]
     let a:Array<any>=Object.values(data)
     let labels:string[]=[]
  ...
  origin(){
    this.lineChartData=[]
    this.dashbordservice.post_surfaceceOrigin(this.Annee).subscribe(data=>{
      console.log(data)
      this.dataset=[]
     let a:Array<any>=Object.values(data)
     let labels:string[]=[]
  ...
  Categorie(){
    this.lineChartData=[]
    this.dashbordservice.post_surfacecategorie(this.Annee).subscribe(data=>{
      console.log(data)
      this.dataset=[]
     let a:Array<any>=Object.values(data)
     let labels:string[]=[]
  ...
  acceptancesurf(){
    ...
    this.lineChartData=[]
    this.dashbordservice.post_surfacecAcceptance(this.Annee).subscribe(data=>{
      console.log(data)
      this.dataset=[]
     let a:Array<any>=Object.values(data)
     let labels:string[]=[]
    ...
    Classification(){
      this.lineChartData=[]
      this.dashbordservice.post_surfaceclassification(this.Annee).subscribe(data=>{
        console.log(data)
        this.dataset=[]
       let a:Array<any>=Object.values(data)
       let labels:string[]=[]
